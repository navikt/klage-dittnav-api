...
internal class SseErrorSuppressingSpanExporter(
    ...
    private fun isSseSpan(sd: SpanData): Boolean {
        ...
        // Fallback: the agent may use the route as the span name (e.g. "GET /api/klanker/{klankeId}/events").
    ...
    private companion object {
        ...
        // Path of the SSE endpoint defined in KlankeController.
...
internal class StatusOverridingSpanData(
    ...
    override fun getInstrumentationScopeInfo(): io.opentelemetry.sdk.common.InstrumentationScopeInfo = delegate.instrumentationScopeInfo
}
