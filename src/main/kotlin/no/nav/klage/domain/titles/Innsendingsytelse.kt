...
enum class Innsendingsytelse(val nb: String, val en: String, val nn: String) {
    ...
    ENF("Enslig forsørger", "Single provider", "Einsleg forsørgjar"),
    ...
    LGA("Lønnsgaranti", "Salary guarantee", "Lønsgaranti"),
    ...
    SIK("Sikkerhetstiltak", "Sikkerhetstiltak", "Sikkerheitstiltak"),
    ...
    TRK("Trekkhåndtering", "Trekkhåndtering", "Trekkhandtering"),
    ...
    VEN("Ventelønn", "Ventelønn", "Venteløn"),
    ...
    GJENLEVENDE(
        ...
        "Pensjon til attlevande ektefelle eller sambuar"
    ),
    ...
    LONNSGARANTI("Lønnsgaranti ved konkurs hos arbeidsgiver", "Salary guarantee upon bankruptcy of employer", "Lønsgaranti ved konkurs hjå arbeidsgivar"),
